...
class Board:
	...
	def construct_board(self, data):
		board = []
		for code in data:
			if not code: board.append(Piece(0))
			elif code == 6 or code == 12: board.append(Pawn(code))
			elif code == 1 or code == 7: board.append(Rook(code))
			elif code == 2 or code == 8: board.append(Knight(code))
			elif code == 3 or code == 9: board.append(Bishop(code))
			elif code == 4 or code == 10: board.append(Queen(code))
			elif code == 5 or code == 11: board.append(King(code))
